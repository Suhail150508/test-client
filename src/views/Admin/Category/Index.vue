      ...
      <div class="card">
        <div class="row card-header bg-transparent border-bottom">
          <div class="col-md-8">
            ...
            <span>
              This is an category related information about Alumni and Student
            </span>
          </div>
          <div class="col-md-4">
        ...
        <div class="card-body">
          ...
          <table class="table table-bordered dt-responsive nowrap w-100">
            ...
            <tbody>
              <tr v-for="(category, index) of categories">
                ...
                <td>
                  <button type="button" @click="show(category)" class="btn btn-info btn-sm">
                    <i class="fas fa-eye"></i>
                  </button>

                  <button type="button" @click="edit(category)" class="btn btn-primary btn-sm">
                    <i class="fas fa-edit"></i>
                  </button>

                  <button type="button" @click="destroy(category.id)" class="btn btn-danger btn-sm">
          ...
          <div v-if="categories.length" class="d-flex">
            <div class="col-md-4 pl-0" style="margin: auto" v-if="categories.length">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="createEditModalLabel"> {{ editMode ? 'Update' : 'Create' }} category</h5>
...
export default {
  ...
  methods: {
    getData(url) {
      this.$Progress.start();
      let linkUrl = url ? url : `${this.backendUrl}category`;
      axios
        .get(linkUrl, {
          params: {
    ...
    update() {
      ...
      this.form.busy = true;
      this.form
        .put(`${this.backendUrl}category/` + this.form.id)
        .then((response) => {
          this.getData();
          $("#createEditModal").modal("hide");
          if (this.form.successful) {
      ...
      this.$swal
        ...
        .then((result) => {
          if (result.isConfirmed) {
            axios.delete(`${this.backendUrl}category/` + id)
            .then((response) => {
