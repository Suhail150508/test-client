      ...
      <div class="card">
        <div class="row card-header bg-transparent border-bottom">
          <div class="col-md-8">
            ...
            <span>
              This is an permission related information
            </span>
          </div>
          <div class="col-md-4">
            <button
        ...
        <div class="card-body">
          ...
          <table class="table table-bordered dt-responsive nowrap w-100">
            ...
            <tbody>
              <tr v-for="(permission, index) of permissions" class="text-center align-middle">
                <td style="width: 10%">{{ index+1 }}</td>
                <td style="width: 35%">{{ permission.name }}</td>
                <td style="width: 20%">{{ permission.parent }}</td>
                <td style="width: 15%" class="text-capitalize">{{ permission.guard_name }}</td>
                <td style="width: 20%">
                  <button
                    type="button"
          ...
          <div v-if="permissions.length" class="d-flex">
            <div
              class="col-md-4 pl-0"
              style="margin: auto"
            ...
            <div class="modal-body">
              ...
              >
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label>Parent</label>
                    <input v-model="form.parent" type="text" name="parent" class="form-control" placeholder="parent" :readonly="showMode == true ? true : false"/>
                    <HasError :form="form" field="parent" />
                  </div>
...
export default {
  ...
  methods: {
    getData(url) {
      this.$Progress.start();
      let linkUrl = url ? url : `${this.backendUrl}permission/list`;
      axios
        .get(linkUrl, {
          params: {
    ...
    store() {
      ...
      this.form.busy = true;
      this.form
        .post(`${this.backendUrl}permission/add`)
        .then((response) => {
          this.getData();
    ...
    update() {
      ...
      this.form.busy = true;
      this.form
        .put(`${this.backendUrl}permission/` + this.form.id)
        .then((response) => {
          this.getData();
          $("#exampleModal").modal("hide");
          if (this.form.successful) {
      ...
      this.$swal
        ...
        .then((result) => {
          if (result.isConfirmed) {
            axios
              .delete(`${this.backendUrl}permission/` + id)
              .then((response) => {
