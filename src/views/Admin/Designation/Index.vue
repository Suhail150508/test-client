      ...
      <div class="card">
        <div class="row card-header bg-transparent border-bottom">
          <div class="col-md-8">
            ...
            <span>This is a designation related information</span>
          </div>
          <div class="col-md-4">
        ...
        <div class="card-body">
          <div class="row mb-3">
            ...
            <div class="col-md-8">
              <div class="row">
                ...
                <div class="col-md-7">
                  <input v-model="keyword" type="text" class="form-control form-control-sm" placeholder="Search" style="height:36px;"/>
                </div>
              </div>
            </div>
          </div>
          ...
          <table class="table table-bordered dt-responsive nowrap w-100">
            ...
            <tbody>
              <tr v-for="(designation, index) of designations">
                ...
                <td>
                  <button type="button" @click="show(designation)" class="btn btn-info btn-sm">
                    <i class="fas fa-eye"></i>
                  </button>

                  <button type="button" @click="edit(designation)" class="btn btn-primary btn-sm">
                    <i class="fas fa-edit"></i>
                  </button>

                  <button type="button" @click="destroy(designation.id)" class="btn btn-danger btn-sm">
          ...
          <div v-if="designations.length" class="d-flex">
            <div class="col-md-4 pl-0" style="margin: auto" v-if="designations.length">
              ...
              <form @submit.prevent="editMode ? update() : store()" @keydown="form.onKeydown($event)">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input v-model="form.short_name" type="text" name="short_name" class="form-control" placeholder="Short name" :readonly="showMode == true ? true : false"/>
                    <HasError :form="form" field="sort_name" />
                  </div>

                  <div class="form-group mb-3">
                    <label>Pay scale</label>
                    <input v-model="form.pay_scale" type="text" name="pay_scale" class="form-control" placeholder="Pay scale" :readonly="showMode == true ? true : false"/>
