    ...
    >
      <div class="row">
        <div class="col-xl-9">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title mb-4">Add New Job Blog Post</h4>
              <div class="mb-3">
...
export default {
  name: "Form",
  components: { Button, HasError, AlertError, AlertErrors, AlertSuccess, QuillEditor },
      ...
      this.form
        ...
        .then((response) => {
          ...
          if (this.form.successful) {
            ...
            // this.$router.push({ name: "app.cccnews" });
          } else {
            this.$Progress.fail();
            this.$notify({
              type: "error",
