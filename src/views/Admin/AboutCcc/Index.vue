        ...
        <div class="col-12">
            <div class="card">
                <div class="row card-header bg-transparent border-bottom">
                    ...
                    <div v-show="aboutCccs.length < 1" class="col-md-4">
                        <router-link :to="{name: 'app.about_ccc_form'}" type="button" @click="create"  class="btn btn-sm btn-success float-end">
...
<!--                            <td>{{ aboutCcc.title }}</td>-->
                            <td v-html="aboutCcc.prelude"></td>
                            <td v-html="aboutCcc.objectives"></td>
                            <td v-html="aboutCcc.mission"></td>
                            <td v-html="aboutCcc.conclusion"></td>
                            ...
                            <td>
                                ...
                                <router-link :to="{ name: 'app.about_ccc_form', query:{aboutCcc: aboutCcc.id}}" class="btn btn-primary btn-sm" >
