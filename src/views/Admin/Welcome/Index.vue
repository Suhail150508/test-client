        ...
        <div class="col-12">
            <div class="card">
                <div class="row card-header bg-transparent border-bottom">
                    <div class="col-md-8">
                        <h4 class="card-title">List Of Welcome Information</h4>
                        <span>
                            This is an Welcome related information about Alumni
                        </span>
                    </div>
                    <div class="col-md-4">
                        <button type="button" @click="create"  class="btn btn-sm btn-success float-end" > <i class="fas fa-plus"></i> Add Welcome</button>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                        <tr v-for="(item, index) of welcome">
                            <td>{{ index+1 }}</td>
                    ...
                    <div v-if="welcome.length" class="d-flex">
                        <div class="col-md-4 pl-0" style="margin: auto;" v-if="welcome.length">
            ...
            <div class="modal fade" id="welcomeCreateEditModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content border-0">
                        <div class="modal-header bg-success">
                            <h5 v-if="showMode == false" class="modal-title text-light fw-bolder" id="welcomeCreateEditModalLabel">{{ editMode ? 'Update' : 'Create' }} Welcome</h5>
                            <h5 v-if="showMode == true" class="modal-title text-light fw-bolder" id="welcomeCreateEditModalLabel">Show Welcome</h5>
    ...
    export default {
        ...
        methods: {
            ...
            create() {
                ...
                this.form.reset()
                this.form.clear()
                $("#welcomeCreateEditModal").modal("show");
            },
            ...
            store() {
                ...
                .then(response => {
                    this.getData()
                    $('#welcomeCreateEditModal').modal('hide')
                    if(this.form.successful){
                        this.$Progress.finish()
                        this.$notify({ type: "success", title: "Success", text: "Welcome speach Added" });
                    }else{
                        this.$Progress.fail()
            ...
            update() {
                ...
                this.form.put(`${this.backendUrl}whoWeAre/`+this.form.id)
                    .then(response => {
                        ...
                        if(this.form.successful){
                            this.$Progress.finish()
                            this.$notify({ type: "success", title: "Success", text: "Welcome speach Updated" });
                        }else{
                            this.$Progress.fail()
                            this.$notify({type: "error", title: "Error", text: 'Something went wrong try again later'})
                        }
            ...
            destroy(id){
                ...
                this.$swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        .then(response => {
                            this.$swal.fire('Deleted!', 'Welcome speach deleted successfully', 'success')
                            this.getData()
                        });
                    }
                })
