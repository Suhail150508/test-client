        ...
        <div class="col-12">
            <div class="card">
                <div class="row card-header bg-transparent border-bottom">
                    <div class="col-md-8">
                        <h4 class="card-title">List of Socio-phyche-Cunseling Applications</h4>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                        <tr v-for="(item, index) of workshopApplications" class="text-center align-middle">
                            <td>{{ index+1 }}</td>
                            <td>{{ item.workshop.title }}</td>
                            <td>{{moment(item.workshop.start_date).format('ll')}} <span style="font-weight: bold">-</span> {{moment(item.workshop.end_date).format('ll')}}</td>
                        ...
                        <tr v-show="!workshopApplications.length">
                            <td colspan="7">
                    ...
                    <div v-if="workshopApplications.length" class="d-flex">
                        <div class="col-md-4 pl-0" style="margin: auto;" v-if="workshopApplications.length">
    ...
    export default {
        ...
        methods: {
            getData(url) {
                ...
                let linkUrl = url ? url :  `${this.backendUrl}workshop-applications/`+workshopId;
                axios.get(linkUrl, {
                    params: {
                    ...
                    .then((response) => {
                        ...
                        this.workshopApplications = response.data.data;
