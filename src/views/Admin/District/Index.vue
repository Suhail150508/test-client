      ...
      <div class="card">
        <div class="row card-header bg-transparent border-bottom">
          <div class="col-md-8">
            ...
            <span>This is a district related information</span>
          </div>
        ...
        <div class="card-body">
          ...
          <table class="table table-bordered dt-responsive nowrap w-100">
            ...
            <tbody>
              <tr v-for="(district, index) of districts">
                ...
                <td>
                  <!-- <button type="button" @click="show(district)" class="btn btn-info btn-sm" style="margin-right: 5px;">
                    <i class="fas fa-eye"></i>
                  </button> -->

                  <button type="button" @click="edit(district)" class="btn btn-primary btn-sm" style="margin-right: 5px;">
                    <i class="fas fa-edit"></i>
                  </button>

                  <button type="button" @click="destroy(district.id)" class="btn btn-danger btn-sm">
          ...
          <div v-if="districts.length" class="d-flex">
            <div class="col-md-4 pl-0" style="margin: auto" v-if="districts.length">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <select class="form-control" v-model="form.division_id">
                      ...
                      <option v-for="division of divisions" :value="division.id" :key="division.id">
                        {{ division.name }}
                      </option>
                    </select>
      ...
      this.form
        ...
        .then((response) => {
          ...
          if (this.form.successful) {
            this.$Progress.finish();
            this.$notify({ type: "success", title: "Success", text: "District Added" });
          } else {
            this.$Progress.fail();
    ...
    update() {
      ...
      this.form
        ...
        .then((response) => {
          ...
          if (this.form.successful) {
            this.$Progress.finish();
            this.$notify({ type: "success", title: "Success", text: "District Updated" });
          } else {
            this.$Progress.fail();
            this.$notify({ type: "error", title: "Error", text: "Something went wrong try again later" });
          }
