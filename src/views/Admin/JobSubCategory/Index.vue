        ...
        <div class="col-12">
            <div class="card">
                <div class="row card-header bg-transparent border-bottom">
                    <div class="col-md-8">
                        <h4 class="card-title">List Of Job Sub Categories</h4>
                        <span>
                            This is an Job Sub Categories related information
                        </span>
                    </div>
                    <div class="col-md-4">
                        <button type="button" @click="create"  class="btn btn-sm btn-success float-end" > <i class="fas fa-plus"></i> Add Job Sub Categories</button>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                        <tr v-for="(item, index) of jobsubcategories">
                            <td>{{ item.id }}</td>
                            <td>{{ item.title }}</td>
                        ...
                        <tr v-show="!jobsubcategories.length">
                            <td colspan="6">
                    ...
                    <div v-if="jobsubcategories.length" class="d-flex">
                        <div class="col-md-4 pl-0" style="margin: auto;" v-if="jobsubcategories.length">
                                    ...
                                    <div class="col-xl-8">
                                        <div class="form-group my-2">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <select class="form-control" v-model="form.job_category_id">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData(url) {
                this.$Progress.start();
                let linkUrl = url ? url :  `${this.backendUrl}jobsub-category`;
                axios.get(linkUrl, {
                    params: {
                    ...
                    .then((response) => {
                        ...
                        this.jobcategories = response.data.jobcategories;
            ...
            store() {
                this.$Progress.start()
                this.form.busy = true
                this.form.post(`${this.backendUrl}jobsub-category`)
                    .then(response => {
                        this.getData()
                        $('#exampleModal').modal('hide')
                        if(this.form.successful){
                            this.$Progress.finish()
                            this.$notify({ type: "success", title: "Success", text: "item Added" });
                        }else{
                            this.$Progress.fail()
            ...
            update() {
                this.$Progress.start()
                this.form.busy = true
                this.form.put(`${this.backendUrl}jobsub-category/`+this.form.id)
                    .then(response => {
                        this.getData()
                        $('#exampleModal').modal('hide')
                        if(this.form.successful){
                            this.$Progress.finish()
                            this.$notify({ type: "success", title: "Success", text: "jobsub-category Updated" });
                        }else{
                            this.$Progress.fail()
                            this.$notify({type: "error", title: "Error", text: 'Something went wrong try again later'})
                        }
            ...
            destroy(id){
                ...
                this.$swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.delete(`${this.backendUrl}jobsub-category/`+id, )
                        .then(response => {
                            this.$swal.fire(
                                'Deleted!',
