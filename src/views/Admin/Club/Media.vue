        ...
        <div class="col-12">
            <div class="card">
                <div class="row card-header bg-transparent border-bottom">
                    <div class="col-md-8">
                        <h4 class="card-title">List Of Media</h4>
                        <span>
                            This is an Club related information about Media
                        </span>
                    </div>
                    <div class="col-md-4">
                    ...
                    <table class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tr v-for="(item, index) of clubs">
                            ...
                            <td class="text-center">
                                <img width="80" :src="item.header_logo" :alt="item.id">
                            </td>
                            <td class="text-center">
                                <img width="80" :src="item.image" :alt="item.id">
                            </td>
                            <td>{{ item.title }}</td>
                            <td v-html="item.description"></td>
                            <td>{{ item.status }}</td>
                            <td>
                                <router-link :to="{ name: 'app.club_view', query:{clubEditId: item.id}}" class="btn btn-info btn-sm" >
